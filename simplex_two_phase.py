...
def standard_input():
    A = genfromtxt('/Users/kaustubhrajimwale/Desktop/Fall 21/IE535/Computing Project/A.csv', delimiter=',')
    A = np.delete(A, 0, 1)

    b = genfromtxt('/Users/kaustubhrajimwale/Desktop/Fall 21/IE535/Computing Project/b.csv', delimiter=',')
    b = np.delete(b, 0, 1)

    C = genfromtxt('/Users/kaustubhrajimwale/Desktop/Fall 21/IE535/Computing Project/C.csv', delimiter=',')
    C = np.delete(C, 0, 1)
